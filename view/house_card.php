...
var slider = function(elem,content,ratio){
	...
	this.suiv=this.div.find('.fleche_droite');
	this.prec=this.div.find('.fleche_gauche');
	...
	this.prec.bind('click',this.fleche_gauche);	
	this.suiv.bind('click',this.fleche_droite);
...
<div id="images">
<a href="#">
<img src="...//view/pictures/search-background.jpg" />
</a>
</div><div id="images">
<a href="#">
<img src="...//view/pictures/search-background.jpg" />
...
<!-- faire un fonction php pour le photos --> 
	</div>
